...
clean:
	$(RM) -f $(OBJDIR)/main $(OBJDIR)/main.o $(OBJDIR)/fileop.o $(OBJDIR)/filesend.o $(OBJDIR)/crc32.o $(OBJDIR)/md5.o $(OBJDIR)/sha256.o $(OBJDIR)/conf.o $(OBJDIR)/misc.o
...
$(OBJDIR)/main: $(OBJDIR)/main.o
	$(CC) $(LDLIBS) $(OBJDIR)/crc32.o $(OBJDIR)/md5.o $(OBJDIR)/sha256.o $(OBJDIR)/misc.o $(OBJDIR)/fileop.o $(OBJDIR)/filesend.o $(OBJDIR)/conf.o $(OBJDIR)/main.o -o $@
